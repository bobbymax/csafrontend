...
const CUVehicleRequest = (
    ...
    const dateDifference = (start, end) => {
        ...
        if (!isNaN(return_date) && !isNaN(required_date)) {
            const duration = Math.floor((return_date - required_date) / (1000 * 60 * 60 * 24));
    ...
    const handleFormSubmit = (e) => {
        ...
        try {
            ...
            if (isUpdating) {
                axios
                    .patch(`vehicleRequests/${state.id}`, body)
                    .then((res) => {
            ...
            >
                ...
                <div className="col-md-6 mb-3">
                    <CSSelect
                        ...
                        onChange={(e) => setState({ ...state, nature_of_trip: e.target.value })
                        }
                    >
