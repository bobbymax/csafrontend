...
const CUTickets = ({
    ...
    const initialState = {
        ...
        floor_id: 0,
        related_issue_id: 0,
        code: `TK${Date.now().toString().slice(7)}`,
        description: "",
        additional_info: "",
        office_no: "",
        status: "pending",
    ...
    const hasFloors = (dependenciess?.locations.find((loc) => loc.id == state.location_id)?.hasFloors == 1)

    // state.user_id === auth.user.id ? console.log("True") : console.log("False")
                ...
                >
                    <div className="col-md-6 mb-3">
                        ...
                        >
                            ...
                            {dependenciess?.departments.map((dept) => (
                                <CSSelectOptions
                                    key={dept?.id}
                                    value={dept?.id}
                                    label={dept?.name}
                    ...
                    <div className="col-md-6 mb-3">
                        ...
                        >
                            ...
                            {dependenciess?.locations.map((loc) => (
                                <CSSelectOptions
                                    key={loc?.id}
                                    value={loc?.id}
                                    label={loc?.name}
                    ...
                    {hasFloors ?
                        (<div className="col-md-5 mb-3">
                            ...
                            >
                                ...
                                {dependenciess?.floors.map((floor) => (
                                    <CSSelectOptions
                                        key={floor?.id}
                                        value={floor?.id}
                                        label={floor?.name}
                    ...
                    <div className="col-md-12 mb-3">
                        ...
                        >
                            ...
                            {dependenciess?.issues.map((floor) => (
                                <CSSelectOptions
                                    key={floor?.id}
                                    value={floor?.id}
                                    label={floor?.name}
